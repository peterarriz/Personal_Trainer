...
test("legacy exact-goal aliases still resolve cleanly without surfacing intake preset rows", () => {
  ...
  assert.deepEqual(runRacePresets, []);
  assert.deepEqual(bigLiftPresets, []);
