...
export const STRUCTURED_GOAL_INTENTS = Object.freeze([
  ...
  createIntent({
    ...
    familyId: "strength",
    title: "Get stronger",
    helper: "Overall strength progression across your main lifts, not one specific lift.",
  ...
  createIntent({
    ...
    helper: "Pick one main lift like bench, squat, deadlift, overhead press, or pull-up.",
