...
const SURFACE_CLARITY_CONTRACT = Object.freeze({
  today: toSurfaceContract({
    ...
    reasonDisclosureTestId: "",
    visibleWordBudget: 175,
    actionLayerTestIds: ["today-primary-cta"],
    collapsedDisclosureTestIds: [],
    visibleCountBudgets: [
      toVisibleCountBudget("planned-session-plan", 0),
      toVisibleCountBudget("today-session-plan", 1, 1),
      toVisibleCountBudget("today-adjust-section", 1, 0),
    ],
  }),
  ...
  log: toSurfaceContract({
    ...
    reasonTestId: "log-trust-row",
    visibleWordBudget: 160,
    actionLayerTestIds: ["log-save-quick"],
    collapsedDisclosureTestIds: [
      "log-advanced-fields",
